package top.xiaomingxing.utils;
...
public class RedisUtil {
    ...
    /**
     * @Description : 批量获取hashKey对应的所有键值
     * @URL         :
     * @param       : keyList
     ...
     * @Date        : 2022/1/3 17:35
     */
    public <T> List<T> hmgetBatch(List<String> keyList) {
        /* 批量获取多条数据 */
        return (List<T>) redisTemplate.executePipelined((RedisCallback<T>) redisConnection -> {
