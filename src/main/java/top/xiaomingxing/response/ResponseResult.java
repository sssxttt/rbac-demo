package top.xiaomingxing.response;

import com.fasterxml.jackson.annotation.JsonInclude;
import top.xiaomingxing.constant.ResultCode;
...
public class ResponseResult<T> {
    ...
    public ResponseResult ok(String msg) {
        return new ResponseResult(ResultCode.SUCCESS.getCode(), msg, null);
    }
    ...
    public ResponseResult fail(String msg, T data) {
